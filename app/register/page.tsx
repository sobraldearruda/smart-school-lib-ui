        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white/20 backdrop-blur-md py-8 px-4 shadow-xl sm:rounded-lg sm:px-10 border border-gray-200/20">
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              <div>
                <button
                  className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-lg font-medium text-white bg-smart-green hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-smart-green transition ease-in-out duration-150"
                  type="submit"
                >
                  Register
                </button>
            ...
            <div className="mt-6">
              <p className="text-center text-sm text-gray-200">
                ...
                <Link className="font-medium text-white hover:text-gray-100 underline" href="/login">
                  Login here
                </Link>
              </p>
            </div>
