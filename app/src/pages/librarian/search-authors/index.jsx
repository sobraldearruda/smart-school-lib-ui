...
export default function LibrarianSearchAuthors() {
    ...
    <div className="dashboard-container">
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <Link to="/librarian/search-authors" className="sidebar-link active">
          ...
          <Link
            to="/librarian/teachers-reading-suggestions"
          ...
          <Link
            to="/librarian/manage-reading-suggestions"
            className="sidebar-link">
