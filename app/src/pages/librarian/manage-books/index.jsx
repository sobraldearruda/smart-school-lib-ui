    ...
    <div className="dashboard-container">
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <Link to="/librarian/manage-books" className="sidebar-link active">
      ...
      <main className="main-content">
        ...
        <section className="loan-cards">
          <div className="loan-card register">
            ...
            <p>Create a new book record for your collection.</p>
          ...
          <div className="loan-card register">
            ...
            <h3>Update Books</h3>
            <p>Update a book record from your bookshelves.</p>
          ...
          <div className="loan-card list">
            ...
            <h3>My Books</h3>
            <p>View and track all your collection.</p>
          ...
          <div className="loan-card list">
            ...
            <h3>Remove Books</h3>
            <p>Remove a book from your collection completely.</p>
