...
export default function LibrarianManageAuthors() {
  return (
    <div className="dashboard-container">
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <Link to="/librarian/manage-authors" className="sidebar-link active">
      ...
      <main className="main-content">
        <header className="main-header">
          <div>
            ...
            <p>Manage your library collection writers.</p>
          </div>
        </header>
        ...
        <section className="loan-cards">
          <div className="loan-card register">
            ...
            <p>Create a new author record for your collection.</p>
          ...
          <div className="loan-card register">
            ...
            <p>Update an author record from your bookshelves.</p>
          ...
          <div className="loan-card list">
            ...
            <h3>My Authors</h3>
            <p>View and track all your collection writers.</p>
            <button className="loan-action-btn list-btn">View</button>
          </div>

          <div className="loan-card list">
            <span className="material-symbols-outlined loan-icon">delete</span>
            <h3>Remove Authors</h3>
            <p>Remove an author from your collection completely.</p>
