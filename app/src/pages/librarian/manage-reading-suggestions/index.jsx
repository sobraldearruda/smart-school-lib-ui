...
export default function LibrarianManageSuggestions() {
  return (
    <div className="dashboard-container">
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <Link to="/librarian/manage-loans" className="sidebar-link">
          ...
          <Link to="/librarian/manage-reading-suggestions" className="sidebar-link active">
      ...
      <main className="main-content">
        <header className="main-header">
          <div>
            <h1>Manage Reading Suggestions</h1>
            <p>Manage your library reading suggestions all in one place.</p>
          </div>
        </header>
        ...
        <section className="loan-cards">
          <div className="loan-card register">
            ...
            <p>Create a suggestion for your school public.</p>
          ...
          <div className="loan-card register">
            ...
            <p>Update a suggestion from your school public.</p>
          ...
          <div className="loan-card list">
            ...
            <p>View and track all suggestions from your school public.</p>
